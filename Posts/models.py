...
from Posts.signals import post_pre_save, likes_pre_save, comments_pre_save, tag_comment_pre_save, post_M2M_changed
...
class Post(models.Model):
    profile = models.ForeignKey(User, on_delete=models.CASCADE, related_name='post')
    slug = models.SlugField(blank=True, max_length=100)
    tag = models.ManyToManyField(User, blank=True, related_name='tagInPost')
...
class Comment(models.Model):
    profile = models.ForeignKey(User, on_delete=models.CASCADE, related_name='comment')
    ...
    tag = models.ManyToManyField(User, blank=True, related_name='commentReply')
    like = models.ManyToManyField(User, blank=True, related_name='commentLikes')
    date = models.DateTimeField(auto_now_add=True)
